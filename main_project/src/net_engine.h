...
// Net_Status NET_ENGINE_init(Net_Engine_Inst *instance_ptr);
// Net_Status NET_ENGINE_config(void *baseaddr_p, void *dmainst_p);
// Net_Status NET_ENGINE_CNN(u32 *input, u32 *output);
// Net_Status NET_ENGINE_Maxpooling(u32 *input, u32 *output);
